...
function App() {
  ...
  const handleCloseLoginModal = () => {
    ...
    setTimeout(() => setLoginModal(false), 200);
  };
    ...
    <>
      ...
      {loginModal && (
        <div
          ...
          className={`fixed top-0 left-0 w-full h-svh bg-black/20 dark:bg-black/40 z-40 transition-opacity duration-200 ${
      ...
      {loginModal && (
        <div
          className={`w-fit h-fit fixed top-0 left-0 right-0 bottom-0 m-auto transition-all duration-200 ease-in-out z-40
                ${
                  animateLoginModal
                    ? "opacity-100"
