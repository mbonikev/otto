            ...
            <div className="w-full flex flex-col gap-10">
              {messages.map((msg, index) => {
                ...
                return (
                  <div
                    key={index}
                    className={`message text-base font-normal text-dark-text leading-[26px] overflow-x-auto no_scroll whitespace-pre-wrap p-1 ${
                      msg.role === "user"
                  ...
                  >
                    {msg.role !== "user" && (
                      <div className="h-8 aspect-square min-w-fit bg-white dark:bg-dark-text-weak rounded-full overflow-hidden ring-1 ring-stone-200/60 p-1">
