          ...
          <div className="w-fit flex-1 flex flex-col items-start justify-center gap-1">
            ...
            <div className="flex-1 w-full max-h-[240px] flex flex-col gap-1">
              ...
              <a
                ...
                className="bg-transparent hover:bg-stone-200 dark:hover:bg-card-hover-dark ring-1 ring-stone-200 dark:ring-card-dark-1 text-dark-text dark:text-light-color py-2 px-3 w-fit min-w-[330px] max-md:min-w-fit max-md:pr-5 max-lg:text-sm flex items-center justify-center gap-3 rounded-2xl"
              >
