  ...
  return (
    <div className="h-svh max-lg:min-h-full flex justify-start items-center flex-col bg-white dark:bg-sidebar-color">
      <div className="w-full h-full flex flex-1">
        ...
        <div className="login_right_side w-1/2 h-full max-lg:hidden flex flex-col items-end justify-center gap-6 pointer-events-none select-none overflow-hidden pt-10 pl-10 bg-blue-100 dark:bg-blue-400/40 relative">
