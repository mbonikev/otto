    ...
    <div className="h-svh flex justify-start items-center flex-col max-lg:p-0">
      <div className="w-full h-full flex">
        <div className="h-full flex-1 flex flex-col items-start justify-start gap-6 w-full p-6">
          ...
          <div className="w-full flex-1 flex flex-col items-start justify-start gap-0">
            <h1 className="text-3xl font-semibold max-2xl:text-2xl mb-4 text-dark-text dark:text-light-color">
              Log in to your account
            </h1>
            <a
              href={`${backendUrl}/auth/google`}
              className="bg-white dark:bg-card-dark-1 hover:bg-stone-200 dark:hover:bg-card-hover-dark ring-1 ring-stone-200 dark:ring-card-dark-1 text-dark-text dark:text-light-color py-2 px-3 w-full max-md:min-w-fit max-md:pr-5 max-lg:text-sm flex items-center justify-start gap-3 rounded-full"
            >
