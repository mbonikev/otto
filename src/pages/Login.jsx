        ...
        <div className="h-full flex-1 flex flex-col items-start justify-start gap-6 w-full p-6">
          ...
          <div className="w-full flex-1 flex flex-col items-center justify-center gap-3">
            ...
            <a
              ...
              className="bg-white dark:bg-body-dark hover:bg-stone-200 ring-1 ring-stone-200 dark:ring-card-dark-2 text-dark-text dark:text-light-color py-2 px-3 w-fit min-w-[230px] max-md:min-w-fit max-md:pr-5 max-lg:text-sm flex items-center justify-start gap-3 rounded-full"
            >
