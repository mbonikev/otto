        ...
        <div className="h-full flex-1 flex flex-col items-start justify-start gap-6 w-full p-4">
          ...
          <div className="w-full flex-1 flex flex-col items-start justify-start gap-3 pt-[5vh]">
            ...
            <a
              ...
              className="bg-white dark:bg-card-dark-1 hover:bg-stone-200 dark:hover:bg-card-hover-dark ring-1 ring-stone-200 dark:ring-card-dark-1 text-dark-text dark:text-light-color py-2 pr-3 pl-28 w-full max-md:min-w-fit max-md:pr-5 max-lg:text-sm flex items-center justify-start gap-3 rounded-full"
            >
