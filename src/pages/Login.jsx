  ...
  return (
    <div className="h-svh max-lg:min-h-full flex justify-start items-center flex-col bg-white dark:bg-sidebar-color">
      <div className="w-full h-full flex flex-1">
        ...
        <div className="login_right_side w-1/2 h-full max-xl:hidden flex flex-col items-end justify-center gap-6 overflow-hidden relative pt-10 pl-10 bg-green-50">
