        ...
        <div className="h-full flex-1 flex flex-col items-start justify-start gap-6 w-full p-4">
          ...
          <div className="w-full flex-1 flex flex-col items-start justify-start gap-3 pt-[5vh]">
            ...
            <a
              ...
              className="bg-white dark:bg-card-dark-1 hover:bg-stone-200 dark:hover:bg-card-hover-dark ring-1 ring-stone-200 dark:ring-card-dark-1 text-dark-text dark:text-light-color py-2.5 px-3 w-full max-md:min-w-fit max-md:pr-5 max-lg:text-sm flex items-center justify-center gap-3 rounded-full"
            >
              <FcGoogle className="text-3xl" />
              <p className="min-w-[65px] font-semibolf">Google</p>
            </a>
            <a
              href={`${backendUrl}/auth/google`}
              className="bg-white dark:bg-card-dark-1 hover:bg-stone-200 dark:hover:bg-card-hover-dark ring-1 ring-stone-200 dark:ring-card-dark-1 text-dark-text dark:text-light-color py-2.5 px-3 w-full max-md:min-w-fit max-md:pr-5 max-lg:text-sm flex items-center justify-center gap-3 rounded-full"
            >
              <FcGoogle className="text-3xl" />
              <p className="min-w-[65px] font-semibolf">Facebook</p>
            </a>
            <a
              href={`${backendUrl}/auth/google`}
              className="bg-white dark:bg-card-dark-1 hover:bg-stone-200 dark:hover:bg-card-hover-dark ring-1 ring-stone-200 dark:ring-card-dark-1 text-dark-text dark:text-light-color py-2.5 px-3 w-full max-md:min-w-fit max-md:pr-5 max-lg:text-sm flex items-center justify-center gap-3 rounded-full"
            >
              <FcGoogle className="text-3xl" />
              <p className="min-w-[65px] font-semibolf">GitHub</p>
            </a>
            <a
              href={`${backendUrl}/auth/google`}
              className="bg-white dark:bg-card-dark-1 hover:bg-stone-200 dark:hover:bg-card-hover-dark ring-1 ring-stone-200 dark:ring-card-dark-1 text-dark-text dark:text-light-color py-2.5 px-3 w-full max-md:min-w-fit max-md:pr-5 max-lg:text-sm flex items-center justify-center gap-3 rounded-full"
            >
              <FcGoogle className="text-3xl" />
              <p className="min-w-[65px] font-semibolf">Microsoft</p>
            </a>
          </div>
