  ...
  return (
    <div className="h-svh flex justify-start items-center flex-col max-lg:p-0">
      <div className="w-full h-full flex">
        ...
        <div className="w-3/5 h-full max-xl:hidden flex flex-col items-end justify-center gap-6 overflow-hidden p-20 bg-stone-100.0">
          <div className="w-full h-fit object-contain overflow-hidden rounded-[30px] relative">
