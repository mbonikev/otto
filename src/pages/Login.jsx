    ...
    <div className="h-svh flex justify-start items-center flex-col max-lg:p-0">
      <div className="w-full h-full flex">
        <div className="h-full flex-1 flex flex-col items-start justify-start gap-6 w-full p-10">
          ...
          <div className="w-full flex items-center justify-between p-2 flex-wrap gap-3 max-lg:justify-center">
        ...
        <div className="w-3/5 h-full max-xl:hidden flex flex-col items-end justify-center gap-6 overflow-hidden p-5 bg-stone-100.0">
          <div className="w-full h-fit object-contain overflow-hidden rounded-[30px] ring-1 ring-stone-200/0 shadow-xl relative">
