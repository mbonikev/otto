      ...
      <div className="w-full h-full flex p-3 gap-3">
        <div className="h-full flex-1 flex flex-col items-start justify-start gap-6 w-full p-4">
          ...
          <div className="w-full flex-1 flex flex-col items-start justify-start gap-3 pt-[5vh]">
            ...
            <div className="saturate-0 opacity-50 bg-white dark:bg-card-dark-1 ring-1 ring-stone-200 dark:ring-card-dark-1 text-dark-text dark:text-light-color py-2.5 px-3 w-full max-md:min-w-fit max-md:pr-5 max-lg:text-sm flex items-center justify-center gap-2 rounded-full">
              <img
