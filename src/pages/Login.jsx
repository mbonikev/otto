...
const Login = () => {
  ...
  return (
    <div className="min-h-svh h-svh max-lg:h-full flex justify-start items-center flex-col bg-sidebar-color overflow-y-auto">
      <div className="w-full h-full flex flex-1 p-3">
        <div className="h-full flex-1 flex flex-col items-center justify-start gap-6 w-full p-10">
          <div className="w-fit flex-1 flex flex-col items-start justify-center gap-1">
            ...
            <div className="flex-1 w-full max-h-[240px] flex flex-col gap-1">
              ...
              <a
                ...
                className="bg-transparent hover:bg-stone-200 dark:hover:bg-card-hover-dark/30 ring-1 ring-stone-200 dark:ring-card-dark-1 text-dark-text dark:text-light-color py-[10px] px-3 w-fit min-w-[330px] max-md:min-w-fit max-md:pr-5 text-sm flex items-center justify-center gap-2 rounded-2xl transition-all active:scale-95"
              >
