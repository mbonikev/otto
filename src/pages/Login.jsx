...
const Login = () => {
  ...
  return (
    <div className="h-svh flex justify-start items-center flex-col bg-sidebar-color">
      <div className="w-full h-full flex p-3">
        <div className="h-full flex-1 flex flex-col items-center justify-start gap-6 w-full overflow-y-auto p-10">
