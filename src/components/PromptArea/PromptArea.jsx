        ...
        <div className="flex items-center justify-between w-full h-[34px] bg-red-400/0 px-1.5 mb-1.5">
          ...
          <div className="w-full h-full flex items-center justify-start gap-3 select-none relative">
            ...
            {showModels && (
              <div
                ref={modelsRef}
                className=" w-[300px] max-sm:w-full h-[300px] bg-white dark:text-light-color dark:bg-card-dark-2 ring-1 ring-stone-300/80 dark:ring-dark-text-weak/50 shadow-md rounded-2xl absolute left-0 bottom-[130%] flex flex-col overflow-hidden p-2"
              >
                    ...
                    Object.entries(
                      ...
                      .map(([owner, ownerModels]) => (
                        <div key={owner} className="w-full">
                          ...
                          {/* Models List */}
                          <div className="w-full h-fit flex flex-col mb-[8px]">
                            {ownerModels
