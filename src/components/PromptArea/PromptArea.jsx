...
function PromptArea({
  ...
  return (
    <div className="w-full h-fit flex flex-col gap-3 px-3 pb-3 z-0 sticky bottom-0 bg-white dark:bg-body-dark">
      <form
        onSubmit={submit}
        className="w-full max-w-[850px] mx-auto h-fit rounded-[25px] shadow-lg ring-1 p-2 ring-stone-200 dark:ring-card-dark-1 dark:bg-card-dark-1 flex flex-col gap-5"
      >
        <textarea
          type="text"
          id="ProjectDesc"
          ...
          className="text-base font-normal bg-transparent min-h-[60px] max-h-[150px] px-3 pt-3 outline-none w-full placeholder:text-dark-text-weak dark:placeholder:text-light-color-weak text-dark-text dark:text-light-color resize-none whitespace-pre-wrap "
        ></textarea>
        <div className="flex items-center justify-between w-full h-[36px] bg-red-400/0 min-h-[32px] px-1.5 mb-1.5">
          ...
          <div className="w-full h-full flex items-center justify-start gap-3 select-none relative">
            <div className=" h-full w-fit px-3 flex items-center justify-center gap-1 text-sm ring-1 ring-stone-300 dark:ring-dark-text-weak dark:hover:bg-light-color-weak/10 text-dark-text-weak font-semibold rounded-full relative">
              {user ? (
                <div
                  ref={modelsButtonRef}
            ...
            <div className="group cursor-pointer h-full w-fit px-3 flex items-center justify-center gap-1 text-sm ring-1 ring-stone-300 dark:ring-dark-text-weak dark:hover:bg-light-color-weak/10 text-dark-text-weak dark:text-light-color-weak dark:hover:text-light-color hover:text-dark-text font-semibold rounded-full relative">
              <GoCommandPalette className="text-lg text-lime-600 stroke-[1px]" />
              Code
              <Tooltip title="Type Codes" placement="right-center" />
            </div>
            <div className="group cursor-default h-full w-fit px-3 flex items-center justify-center gap-1 text-sm ring-1 ring-stone-300 dark:ring-dark-text-weak dark:hover:bg-light-color-weak/10 text-dark-text-weak dark:text-light-color-weak font-semibold rounded-full relative">
            ...
            {showModels && (
              <div
                ref={modelsRef}
                className="w-[300px] max-sm:w-full h-[300px] bg-white dark:text-light-color dark:bg-card-dark-2 ring-1 ring-stone-300/80 dark:ring-dark-text-weak shadow-md rounded-2xl absolute left-0 bottom-[130%] py-2 pl-2 flex flex-col"
              >
                <div className="h-[40px] mb-2 pr-2">
                  <div className="w-full h-full bg-stone-200/60 dark:bg-light-color-weak/20  rounded-xl flex items-center justify-start">
                    ...
                    <input
                      ...
                      className="h-full w-full bg-transparent text-dark-text dark:text-light-color placeholder:text-dark-text-weak/50 dark:placeholder:text-light-color-weak text-sm font-normal"
                            ...
                            {ownerModels
                              ...
                              .map((model) => (
                                <div
                                  ...
                                  className="px-2 py-1.5 rounded-lg w-full hover:bg-stone-200/60 text-dark-text-weak hover:text-dark-text dark:hover:bg-light-color-weak/15 dark:text-light-color-weak dark:hover:text-light-color text-sm font-medium cursor-pointer flex items-center justify-between"
                                >
                                  {model.id}
