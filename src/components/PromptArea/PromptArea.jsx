            ...
            <div className=" h-full w-fit flex items-center justify-center gap-1 text-sm ring-1 ring-stone-300  dark:ring-dark-text-weak/50 dark:hover:bg-light-color-weak/10 text-dark-text-weak font-semibold rounded-full relative">
              {user ? (
                <div
                  ...
                  className="group cursor-pointer w-full h-full flex items-center justify-center gap-1.5 px-3 hover:text-dark-text dark:text-light-color-weak dark:hover:text-light-color"
                >
                ...
                <div className="group cursor-pointer w-full h-full flex items-center justify-center gap-1.5 px-3 hover:text-dark-text dark:text-light-color-weak dark:hover:text-light-color">
                  <LuBrain className="text-lg text-purple-500" />
                  <p className="w-full truncate max-w-[100px]">
                    {selectedModel}
                  </p>
