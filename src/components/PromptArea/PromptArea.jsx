    ...
    <div className="w-full h-fit flex flex-col gap-2 px-3 pb-2 z-0 sticky bottom-0 bg-white dark:bg-body-dark">
      ...
      >
        <textarea
          ...
          className="text-base font-normal bg-transparent min-h-[50px] max-h-[150px] px-3 pt-1 outline-none w-full placeholder:text-dark-text-weak dark:placeholder:text-light-color-weak text-dark-text dark:text-light-color resize-none whitespace-pre-wrap "
        ></textarea>
