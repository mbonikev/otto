    ...
    <div className="w-full h-fit flex flex-col gap-3 px-3 pb-3 z-0 sticky bottom-0 bg-white dark:bg-body-dark">
      ...
      >
        <textarea
          ...
          className="text-base font-normal bg-transparent min-h-[60px] max-h-[150px] px-3 pt-3 outline-none w-full placeholder:text-dark-text-weak dark:placeholder:text-light-color text-dark-text resize-none whitespace-pre-wrap "
        ></textarea>
