                            ...
                            {ownerModels
                              ...
                              .map((model) => (
                                <div
                                  ...
                                  className="px-2 py-1.5 rounded-lg w-full hover:bg-stone-200/60 text-dark-text-weak hover:text-dark-text dark:hover:bg-light-color-weak text-sm font-medium cursor-pointer flex items-center justify-between"
                                >
                                  {model.id}
