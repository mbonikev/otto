...
function PromptArea() {
  ...
  return (
    <div className="w-full h-fit flex flex-col gap-3 p-3">
      <div className="w-full max-w-[800px] mx-auto h-fit rounded-[20px] shadow-lg ring-1 p-1 ring-stone-200 overflow-hidden">
        <textarea
          type="text"
          id="ProjectDesc"
          value={message}
        ...
        ></textarea>
        <div className="flex items-center justify-between w-full  min-h-[40px] bg-red-400/0 px-1">
          {/* 1 */}
          <div></div>
          {/* 2 */}
          <div className="w-fit h-full">
            <button className="group h-ull w-auto aspect-square flex items-center justify-center text-3xl text-dark-text rounded-full relative">
              <BsArrowUpCircleFill />
            </button>
          </div>
        </div>
