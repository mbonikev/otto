  ...
  return (
    <div className="w-full h-fit flex flex-col gap-3 p-3">
      <div className="w-full max-w-[750px] mx-auto h-fit rounded-[25px] shadow-lg ring-1 p-1 ring-stone-200 overflow-hidden">
        ...
        ></textarea>
        <div className="flex items-center justify-between w-full h-[40px] min-h-[40px] bg-red-400/0 p-2">
          {/* 1 */}
          <div>
          ...
          <div className="w-fit h-full">
            <button className="group h-full w-auto aspect-square flex items-center justify-center text-[34px] text-dark-text rounded-full relative">
              <BsArrowUpCircleFill />
            </button>
          </div>
        </div>
