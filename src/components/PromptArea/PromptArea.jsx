...
function PromptArea({
  ...
  return (
    <div className="w-full h-fit flex flex-col gap-3 px-3 pb-3 z-0 sticky bottom-0 bg-white dark:bg-body-dark">
      <form
        onSubmit={submit}
        className="w-full max-w-[800px] mx-auto h-fit rounded-[25px] shadow-lg ring-1 p-2 ring-stone-200 dark:ring-card-dark-1 dark:bg-card-dark-1 flex flex-col gap-5"
      >
        <textarea
          type="text"
          id="ProjectDesc"
      ...
      <h1 className="text-xs font-normal text-dark-text dark:text-light-color w-fit mx-auto">
