        ...
        <div className="flex items-center justify-between w-full h-[36px] bg-red-400/0 min-h-[32px] px-1.5 mb-1.5">
          ...
          <div className="w-full h-full flex items-center justify-start gap-3 select-none relative">
            ...
            {showModels && (
              <div
                ref={modelsRef}
                className="w-[300px] max-sm:w-full h-[300px] bg-white dark:text-light-color-weak dark:bg-card-dark-2 ring-1 ring-stone-300/80 dark:ring-dark-text-weak shadow-md rounded-2xl absolute left-0 bottom-[130%] py-2 pl-2 flex flex-col"
              >
