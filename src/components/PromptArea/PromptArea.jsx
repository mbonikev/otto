          ...
          <div className="w-full h-full flex items-center justify-start gap-3 select-none relative">
            ...
            {showModels && (
              ...
              >
                ...
                <div className="w-full flex-1 flex flex-col gap-0 scrollbar_nobg overflow-y-auto pr-1">
                  {models?.length > 0 ? (
                    Object.entries(
                      models
                        .filter(
                      ...
                      .map(([owner, ownerModels]) => (
                        <div key={owner} className="w-full">
                          {/* Owner Header */}
                          <h1 className="text-xs font-normal text-dark-text-weak/60 dark:text-light-color-weak py-1.5 px-2">
                            {owner}
                          </h1>
                          {/* Models List */}
