      ...
      >
        ...
        <div className="flex items-center justify-between w-full h-[36px] bg-red-400/0 min-h-[32px] px-1.5 mb-1.5">
          ...
          <div className="w-full h-full flex items-center justify-start gap-3 select-none relative">
            <div className=" h-full w-fit flex items-center justify-center gap-1 text-sm ring-1 ring-stone-300  dark:ring-dark-text-weak/50 dark:hover:bg-light-color-weak/10 text-dark-text-weak font-semibold rounded-full ==">
              {user ? (
                <div
                  ref={modelsButtonRef}
                  onClick={() => setShowModels(true)}
                  className="group cursor-pointer w-full h-full flex items-center justify-center gap-1.5 px-3 relative hover:text-dark-text dark:text-light-color-weak dark:hover:text-light-color"
                >
                ...
                <div className="group cursor-pointer w-full h-full flex items-center justify-center gap-1.5 px-3 relative hover:text-dark-text dark:text-light-color-weak dark:hover:text-light-color">
                  <LuBrain className="text-lg text-purple-500" />
                  <p className="w-full truncate max-w-[100px]">
                    {selectedModel}
                  </p>
          ...
          <div className="w-fit h-full">
            <button
              ...
              className={`group h-full w-auto aspect-square flex items-center justify-center text-dark-text dark:text-light-color hover:opacity-70 rounded-full relative pr-1 pb-1
