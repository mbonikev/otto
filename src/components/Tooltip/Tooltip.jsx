...
function Tooltip({ title, placement }) {
  return (
    <div className={`absolute top-[125%] w-fit whitespace-nowrap px-3 py-1 rounded-[9px] left-0 bg-[#1b1b1b] text-white/90 text-[13px] font-semibold ${placement === "left" ? "" : placement === "center" ? "" : ""}`}>
