    ...
    <div className="w-[320px] h-fit p-2">
      <div className="w-full h-full bg-white dark:bg-card-dark-1 text-dark-text dark:text-light-color rounded-2xl p-5 flex flex-col gap-3">
        ...
        <a
          ...
          className="bg-stone-200/60 hover:bg-stone-200 ring-1 ring-stone-200 text-dark-text py-2 px-3 w-fit min-w-[260px] max-md:min-w-fit max-md:pr-5 max-lg:text-sm flex items-center justify-start gap-3 rounded-full"
        >
