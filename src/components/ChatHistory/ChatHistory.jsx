          ...
          <div className="w-full h-full bg-transparent rounded-xl flex items-center justify-start">
            ...
            {searchValue !== "" && (
              <HiMiniXCircle
                ...
                className="mx-2 min-w-fit text-xl text-dark-text-weak/40 dark:text-light-color-weak hover:text-dark-text-weak dark:hover:text-light-color-weak transition cursor-pointer"
              />
            )}
          </div>
        </div>
            ...
            <div className="flex flex-col w-full h-full gap-0.5">
              {filteredConvs.length === 0 ? (
                ...
                <div className="w-full min-h-full flex items-center justify-center">
                  <PiChatsCircleFill className="text-dark-text-weak dark:text-light-color-weak text-5xl" />
                </div>
              )}
            </div>
          )}
