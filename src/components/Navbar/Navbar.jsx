  ...
  return (
    <div className="w-full h-fit bg-white/80 dark:bg-body-dark/80 backdrop-blur-lg grid grid-cols-3 text-dark-text dark:text-light-color px-4 py-2 sticky">
      ...
      <div className="flex items-center justify-center gap-1 select-none w-full max-w-[100px] h-full mx-auto relative group bg-transparent">
        ...
        <div className="w-7 min-w-7 z-10 group-hover:w-16 absolute top-1.5 left-0 right-0 m-auto delay-150 group-hover:translate-y-5 transition-all saturate-0 group-hover:saturate-100 opacity-65">
