      ...
      <div className="flex items-center justify-end gap-0 relative select-none">
        {user ? (
          ...
          <>
            ...
            <button
              onClick={() => (window.location = "/#/login")}
              className="group h-10 w-fit px-4 flex items-center justify-center text-base bg-stone-100 text-dark-text-weak hover:text-dark-text rounded-full relative"
            >
              Login
            </button>
          </>
