      ...
      <div className="flex items-center justify-end gap-0 relative select-none">
        {user ? (
          ...
          <>
            ...
            <button
              onClick={() => (window.location = "/#/login")}
              className="group h-12 ml-2 w-fit px-6 flex items-center justify-center text-lg font-medium bg-dark-text text-white rounded-full dark:text-dark-text dark:bg-white relative"
            >
              Login
            </button>
          </>
