  ...
  return (
    <div className="w-full h-[70px] min-h-[70px] bg-white grid grid-cols-3 text-dark-text px-4 sticky">
      ...
      <div className="flex items-center justify-center gap-1 select-none w-full max-w-[100px] mx-auto relative group bg-transparent">
        {/* info */}
        <div className="w-[230px] h-[185px] delay-150 scale-0 group-hover:scale-100 opacity-0 group-hover:opacity-100 transition-all bg-transparent absolute top-0 mx-auto z-10 pt-2">
          <div className="w-full h-full bg-white ring-1 ring-stone-200 shadow-lg rounded-3xl pt-[88px] px-2 pb-2 text-center">
            <h1 className="font-Kanit delay-150 transition-all whitespace-nowrap opacity-0 group-hover:opacity-100 text-2xl font-light text-dark-text-weak text-center">
              Otto
              <span className="text-xs mx-1 rounded-xl bg-stone-200/50 font-Inter px-2 py-0.5 delay-150 transition-all whitespace-nowrap opacity-0 group-hover:opacity-100 font-semibold text-dark-text-weak mt-0">
                1.0.1
              </span>
            </h1>
          <div className="w-full flex flex-col">
            <div className="w-full h-9 bg-red-200 flex items-center justify-between">
              <div className="flex-1 flex">
                <div className="w-10 h-10 aspect-square flex justify-center items-center rounded-full bg-stone-200/50 text-dark-text text-lg"><BsStars /></div>
                <span></span>
              </div>
            </div>
          </div>
