  ...
  return (
    <div className="w-full h-[70px] min-h-[70px] bg-white grid grid-cols-3 text-dark-text px-4 sticky">
      ...
      <div className="flex items-center justify-center gap-1 select-none w-full max-w-[100px] mx-auto relative group bg-transparent">
        {/* info */}
        <div className="w-[210px] h-[185px] delay-150 scale-0 group-hover:scale-100 opacity-0 group-hover:opacity-100 transition-all bg-transparent absolute top-0 mx-auto z-10 pt-2">
          ...
          <div className="w-full flex flex-col">
            <div className="w-full h-14 bg-red-200">d</div>
          </div>
          </div>
        </div>
