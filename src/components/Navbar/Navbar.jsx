        ...
        {user ? (
          <>
            ...
            {showPopup && (
              ...
              >
                <button className="w-full rounded-xl p-2 flex items-center justify-start gap-2 hover:bg-stone-100 text-dark-text-weak hover:text-dark-text dark:text-light-color dark:hover:bg-light-color-weak/10">
                ...
                <button
                  ...
                  disabled={loading}
                  className="w-full rounded-xl p-2 flex items-center justify-start gap-2 hover:bg-stone-100 text-dark-text-weak hover:text-dark-text dark:text-light-color dark:hover:bg-light-color-weak/10"
                >
                  {loading ? (
                    <>
