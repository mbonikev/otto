      ...
      <div className="flex items-center justify-end gap-0 relative select-none">
        {user ? (
          ...
          <>
            ...
            <button
              onClick={() => (window.location = "/#/login")}
              className="group h-10 ml-2 w-fit px-6 flex items-center justify-center text-base bg-dark-text text-white rounded-full dark:text-light-color-weak dark:hover:bg-white dark:hover:text-light-color relative"
            >
              Login
            </button>
          </>
