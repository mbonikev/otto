...
function Navbar({
  ...
  return (
    <div className="w-full h-fit bg-white/80 dark:bg-body-dark/80 backdrop-blur-lg grid grid-cols-3 text-dark-text dark:text-light-color px-5 max-md:px-3 py-2 sticky top-0">
      {/* Overlay */}
      {chatsModal && (
        <div
        ...
        {user && showPopup && (
          ...
          >
            ...
            >
              {loading ? (
                <>
                  <LuLoaderCircle className="text-2xl text-dark-text-weak dark:text-light-color-weak animate-spinLoader" />
                  <h1 className="text-sm">Sign Out</h1>
                </>
              ) : (
                <>
                  <HiOutlineArrowRightStartOnRectangle className="text-2xl text-dark-text-weak dark:text-light-color-weak" />
                  <h1 className="text-sm">Sign Out</h1>
                </>
              )}
            </button>
