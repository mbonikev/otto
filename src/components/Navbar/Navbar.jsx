        ...
        {user && showPopup && (
          ...
          >
            {/* <button className="w-full rounded-xl p-2 flex items-center justify-start gap-2 hover:bg-stone-100 text-dark-text hover:text-dark-text dark:text-light-color dark:hover:text-light-color dark:hover:bg-light-color-weak/10">
              <HiOutlineUser className="text-xl text-dark-text-weak/70 dark:text-light-color-weak" />
            ...
            {/*  */}
            <button className="w-full rounded-xl p-2 flex items-center justify-start gap-2 hover:bg-stone-100 text-dark-text hover:text-dark-text dark:text-light-color dark:hover:text-light-color dark:hover:bg-light-color-weak/10">
              <HiOutlineSparkles className="text-xl text-dark-text-weak/70 dark:text-light-color-weak" />
              <h1 className="text-sm">Upgrade Plan</h1>
            </button>
            <button className="w-full rounded-xl p-2 flex items-center justify-start gap-2 hover:bg-stone-100 text-dark-text hover:text-dark-text dark:text-light-color dark:hover:text-light-color dark:hover:bg-light-color-weak/10">
              <HiOutlineMegaphone className="text-xl text-dark-text-weak/70 dark:text-light-color-weak" />
