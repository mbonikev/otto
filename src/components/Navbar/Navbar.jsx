  ...
  return (
    <div className="w-full h-[70px] grid grid-cols-3 text-dark-text px-4">
      ...
      <div className="flex items-center justify-end gap-1 relative select-none">
        <button className="group h-10 w-auto aspect-square flex items-center justify-center text-sm hover:bg-stone-100 text-dark-text-weak hover:text-dark-text rounded-full relative">
