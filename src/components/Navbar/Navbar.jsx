        ...
        {user ? (
          <>
            <button
              ...
              className="group h-10 w-auto aspect-square flex items-center justify-center text-2xl hover:bg-stone-100 text-dark-text-weak dark:text-light-color-weak hover:text-dark-text dark:hover:bg-card-dark-1 rounded-full relative"
            >
              <HiOutlineChatBubbleLeftRight />
              <Tooltip
                title="Chat history"
